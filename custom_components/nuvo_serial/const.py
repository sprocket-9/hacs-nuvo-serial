...
SERVICE_SET_SOURCE_TRACK = "set_source_track"
...
SERVICE_ATTR_STATUS = "status"
SERVICE_ATTR_TRACK_DURATION = "track_duration"
SERVICE_ATTR_TRACK_POSITION = "track_position"
