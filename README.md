...
- [Nuvo Serial](#nuvo-serial)
  ...
  - [Services](#services)
    - [nuvo_serial.page_on](#nuvo_serialpage_on)
    - [nuvo_serial.page_off](#nuvo_serialpage_off)
    - [nuvo_serial.party_on](#nuvo_serialparty_on)
    - [nuvo_serial.party_off](#nuvo_serialparty_off)
    - [nuvo_serial.snapshot](#nuvo_serialsnapshot)
    - [nuvo_serial.restore](#nuvo_serialrestore)
    - [nuvo_serial.configure_time](#nuvo_serialconfigure_time)
  - [Keypad Services](#keypad-services)
    - [nuvo_serial.simulate_next_button](#nuvo_serialsimulate_next_button)
    - [nuvo_serial.simulate_prev_button](#nuvo_serialsimulate_prev_button)
    - [nuvo_serial.simulate_play_pause_button](#nuvo_serialsimulate_play_pause_button)
  - [Keypad now-playing metadata](#keypad-now-playing-metadata)
    - [nuvo_serial.set_source_display](#nuvo_serialset_source_display)
    - [nuvo_serial.set_source_track](#nuvo_serialset_source_track)
